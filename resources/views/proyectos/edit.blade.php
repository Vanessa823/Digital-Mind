        ...
        <div class="col-md-12">
            ...
            <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <input type="date" class="form-control shadow-none" id="fecha_inicio" name="fecha_inicio" value="{{$proyecto->fecha_inicio}}">
              </div>
              <div class="col-md-6">
                <label for="descripcion" class="form-label">Fecha de entrega</label>
                <input type="date" class="form-control shadow-none" id="fecha_entrega" name="fecha_entrega" value="{{$proyecto->fecha_entrega}}">
              </div>
              <!-- <div class="col-md-6">
